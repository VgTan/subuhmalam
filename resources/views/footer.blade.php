<footer class="bg-[#F29A4B] bg-opacity-30 border-t-4 border-[#ff8400] text-white py-4 md:py-6 lg:py-8 mt-[130px]">
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center px-4 md:px-6 lg:px-8">
        <div class="text-center md:text-left mb-4 md:mb-0">
            <div class="flex justify-center">
                <img src="./images/logo.png" alt="Logo" class="lg:w-full w-[150px] md:w-80" />
            </div>
            <p class="text-xs">© SubuhMalam 2023. All rights reserved.</p>
        </div>
